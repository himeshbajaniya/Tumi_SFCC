...
function createProductListItemObject(productListItemObject) {
    ...
    if (productListItemObject) {
        ...
        result = {
            ...
            grandCollection: productListItemObject.product.custom.grandCollection ? productListItemObject.product.custom.grandCollection : '',
            ...
            badge: productListItemObject.product.custom.badge ? productListItemObject.product.custom.badge : null,
            collection: productListItemObject.product.custom.grandCollection ? productListItemObject.product.custom.grandCollection : productListItemObject.product.custom.collection ? productListItemObject.product.custom.collection : null,
            turntoAverageRating: productListItemObject.product.custom.turntoAverageRating ? productListItemObject.product.custom.turntoAverageRating : null
        };
        decorators.badges(result, productListItemObject.product);
