...
function edqSetGlobalIntuitiveConfiguration() {
	...
	* Configuration option to include Data Sets for Global Intuitive*/
	...
	window.EdqConfig.GLOBAL_INTUITIVE_CALLBACK = function () {
		$(edqAddressLine1Id).trigger('blur');
		$(edqPostalLineId).trigger('blur');
		$(edqCityLineId).trigger('blur');
		$(edqStateLineId).trigger('blur').trigger('change');
	}
}
