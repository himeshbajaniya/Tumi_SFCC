...
var run = function run() {
    ...
    var serviceClient = emarsysFTPService.getFTPService(serviceID);
    ...
    var fileList;
    if (recursive) {
        fileList = jobHelper.getFileListRecursive(sourceDirStr, filePattern, sourceFolder, targetFolder, recursive);
    } else {
        fileList = jobHelper.getFiles(sourceDirStr, filePattern);
    }
    ...
    serviceClient.uploadFiles(fileList, targetFolder, archiveFolder, recursive);
