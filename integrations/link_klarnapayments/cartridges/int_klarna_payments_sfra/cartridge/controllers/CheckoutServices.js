...
server.append(
    ...
    function (req, res, next) {
        ...
        if (('paymentMethod' in viewData && viewData.paymentMethod.value === 'KLARNA_PAYMENTS') || ('form' in viewData && 'paymentMethod' in viewData.form && viewData.form.paymentMethod.value === 'KLARNA_PAYMENTS')) {
            COHelpers.removeAllNonGiftCardPaymentInstruments(currentBasket);
        }
