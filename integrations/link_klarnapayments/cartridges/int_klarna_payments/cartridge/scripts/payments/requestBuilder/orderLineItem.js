...
OrderLineItem.prototype.generateItemImageURL = function( li ) {
    ...
    if ( li.optionProductLineItem ) {
        styleVariant = Object.hasOwnProperty.call(li.parent.getProduct().custom, 'styleVariant') && li.parent.getProduct().custom.styleVariant ? li.parent.getProduct().custom.styleVariant : '';
        url = OrderHelpers.getImageURL(styleVariant);
    } else {
        styleVariant = Object.hasOwnProperty.call(li.getProduct().custom, 'styleVariant') && li.getProduct().custom.styleVariant ? li.getProduct().custom.styleVariant : '';
        url = OrderHelpers.getImageURL(styleVariant);
    }
