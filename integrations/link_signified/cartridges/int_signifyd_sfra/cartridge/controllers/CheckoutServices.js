...
server.replace('PlaceOrder', server.middleware.https, function (req, res, next) {
    ...
    var SignifydCreateCasePolicy = dw.system.Site.getCurrent().getCustomPreferenceValue('SignifydCreateCasePolicy'); // eslint-disable-line no-undef
    ...
    if (SignifydCreateCasePolicy === 'PRE_AUTH') {
        ...
        if (!empty(response) && response.declined) { // eslint-disable-line no-undef
            Transaction.wrap(function () {
