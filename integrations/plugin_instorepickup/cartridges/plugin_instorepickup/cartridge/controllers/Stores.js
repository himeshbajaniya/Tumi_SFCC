...
server.replace('FindStores', function (req, res, next) {
    ...
    var url = null;
    var products = buildProductListAsJson(req.querystring.products);
    var storesModel = storeHelpers.getStores(radius, postalCode, lat, long, req.geolocation, showMap, url, products, req.currentCustomer.profile);
    ...
    storesModel.resources = {
        textInStock: Resource.msg('text.in.stock', 'product', null),
        textAvailableTomorrow: Resource.msg('text.available.tomorrow', 'product', null),
        textTumiStore: Resource.msg('text.tumi.store', 'product', null),
        textViewDays: Resource.msg('text.view.all.days', 'product', null),
        textStoreDetails: Resource.msg('text.store.details', 'product', null),
        textShowLess: Resource.msg('text.show.less', 'product', null),
        textOOS: Resource.msg('text.out.of.stock', 'product', null)
    };
