...
function calculatePaymentTransaction(currentBasket) {
    ...
    try {
        Transaction.wrap(function () {
            ...
            if (paymentInstrument.getPaymentMethod() === PaymentInstrument.METHOD_GIFT_CERTIFICATE) {
                return;
            }

            if (paymentInstruments.length === 1 && !(paymentInstrument.paymentMethod.equals(CybersourceConstants.METHOD_PAYPAL) || paymentInstrument.paymentMethod.equals(CybersourceConstants.METHOD_PAYPAL_CREDIT))) {
