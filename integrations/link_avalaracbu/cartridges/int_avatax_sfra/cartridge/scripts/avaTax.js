...
var connectorName = (session.privacy.sitesource && session.privacy.sitesource == 'sgjc') ? 'SF B2C/SGJC' : 'SF B2C QuickStart';
...
module.exports = {
	...
	updateAllPriceAdjustments: updateAllPriceAdjustments
};