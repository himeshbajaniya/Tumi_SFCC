...
function getClientId() {
    ...
    const serviceName = require('*/cartridge/scripts/paypal/helpers/paypalHelper').getServiceName(siteID);
...
function getUrls() {
    return {
        ...
        placeOrderStage: URLUtils.url('Checkout-Begin', 'stage', 'placeOrder', 'fromPayPalExpress', 'true').toString(),
        shippingStage: URLUtils.url('Checkout-Begin', 'stage', 'shipping', 'fromPayPalExpress', 'true', 'phonenumbermissing', 'true').toString(),
