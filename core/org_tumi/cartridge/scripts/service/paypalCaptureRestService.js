...
function createRequest(service, data) {
    ...
    if (!(credential instanceof ServiceCredential)) {
        throw new Error(Resource.msgf('service.nocredentials', 'paypalbm', null, 'int_paypal.http.rest'));
    }
...
module.exports = function () {
    ...
    return LocalServiceRegistry.createService(serviceName, createRestService());
};
