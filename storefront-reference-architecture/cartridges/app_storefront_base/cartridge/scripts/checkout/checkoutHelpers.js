...
function placeOrder(order, fraudDetectionStatus) {
    ...
    try {
        ...
        // Marking Order export status NOT EXPORTED intentionally here, will be marked READY FOR EXPORT in postOrderProcessing.js after all the modifications done for OMS.
